...
export const formatSchema = z.object({
  ...
  tps_text_height_mm: z.string().optional(),
  tps_text_width_mm: z.string().optional(),
  tps_text_depth_mm: z.string().optional(),
        ...
        try {
          ...
          if (data) {
            form.reset({
              ...
              tps_text_height_mm: data.tps_text_height_mm?.toString() || "",
              tps_text_width_mm: data.tps_text_width_mm?.toString() || "",
              tps_text_depth_mm: data.tps_text_depth_mm?.toString() || "",
              extent: data.extent || "",
  ...
  async function onSubmit(values: FormatFormValues) {
    ...
    try {
      ...
      const formattedValues = {
        ...
        tps_text_height_mm: values.tps_text_height_mm ? parseFloat(values.tps_text_height_mm) : null,
        tps_text_width_mm: values.tps_text_width_mm ? parseFloat(values.tps_text_width_mm) : null,
        tps_text_depth_mm: values.tps_text_depth_mm ? parseFloat(values.tps_text_depth_mm) : null,
