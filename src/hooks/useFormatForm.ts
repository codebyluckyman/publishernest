...
export const formatSchema = z.object({
  ...
  tps_height_mm: z.string().optional(),
  tps_width_mm: z.string().optional(),
  tps_depth_mm: z.string().optional(),
  tps_plc_height_mm: z.string().optional(),
  tps_plc_width_mm: z.string().optional(),
  tps_plc_depth_mm: z.string().optional(),
        ...
        try {
          ...
          if (data) {
            form.reset({
              ...
              tps_height_mm: data.tps_height_mm?.toString() || "",
              tps_width_mm: data.tps_width_mm?.toString() || "",
              tps_depth_mm: data.tps_depth_mm?.toString() || "",
              tps_plc_height_mm: data.tps_plc_height_mm?.toString() || "",
              tps_plc_width_mm: data.tps_plc_width_mm?.toString() || "",
              tps_plc_depth_mm: data.tps_plc_depth_mm?.toString() || "",
              extent: data.extent || "",
  ...
  async function onSubmit(values: FormatFormValues) {
    ...
    try {
      ...
      const formattedValues = {
        ...
        tps_height_mm: values.tps_height_mm ? parseFloat(values.tps_height_mm) : null,
        tps_width_mm: values.tps_width_mm ? parseFloat(values.tps_width_mm) : null,
        tps_depth_mm: values.tps_depth_mm ? parseFloat(values.tps_depth_mm) : null,
        tps_plc_height_mm: values.tps_plc_height_mm ? parseFloat(values.tps_plc_height_mm) : null,
        tps_plc_width_mm: values.tps_plc_width_mm ? parseFloat(values.tps_plc_width_mm) : null,
        tps_plc_depth_mm: values.tps_plc_depth_mm ? parseFloat(values.tps_plc_depth_mm) : null,
